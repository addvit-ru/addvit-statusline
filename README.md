...
- **[addvit-statusline](plugins/addvit-statusline/)** — rich statusLine with rolling token windows and live rate-limit countdowns.
...
```json
{
  ...
  "description": "Rich statusLine: context bar, rolling 5h/24h/7d token windows, API rate-limits with countdown to reset (5h:24% (2h34m)), cwd and git branch.",
